...
Monte Carlo simulation is supported by the integration of the R statistical package in this project.
...
The steps to run the Monte Carlo simulation have been provided below:
